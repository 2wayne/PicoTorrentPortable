...
user in an INI file next to PicoTorrentPortable.exe called PicoTorrentPortable.ini.
...
copy AppNamePortable.ini from this directory to PicoTorrentPortable.ini next to
PicoTorrentPortable.exe. The options in the INI file are as follows:
